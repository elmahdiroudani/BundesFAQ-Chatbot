...
export const UploadFile: React.FC<Props> = ({ className, disabled }: Props) => {
    ...
    // Handle the case when authentication is not enabled
    if (!useLogin) {
        return (
                    ...
                    >
                        <div className={styles.calloutContainer}>
                            <Text className={styles.calloutText}>
                                File upload is not available when authentication is disabled.
                                Enable authentication in your backend configuration to use this feature.
                            </Text>
                        </div>
                    </Callout>
                )}
