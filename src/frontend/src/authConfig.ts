...
async function fetchAuthSetup(): Promise<AuthSetup> {
    try {
        ...
        console.warn("Backend not available, using default auth setup without authentication");
        // Fallback configuration for development without backend
        return {
            useLogin: false,
            ...
            msalConfig: {
                auth: {
                    ...
                    authority: "https://login.microsoftonline.com/demo-tenant-id",
                    redirectUri: "/",
